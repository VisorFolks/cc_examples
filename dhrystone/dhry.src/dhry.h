 ...
 *
 * File Name		: dhry.h
 * Description		: This is header file of dhrystone benchmark
...
#define CLOCK_TYPE "get_timestamp()"
#ifndef HZ
#define HZ	(1000000) /* time() returns time in seconds */
#endif
#define Too_Small_Time 2*HZ /* Measurements should last at least 2 seconds */
#define Start_Timer() get_timestamp((uint64_t *)&Begin_Time)
#define Stop_Timer()  get_timestamp((uint64_t *)&End_Time)
